				...
				if (opts.mode == "time") {
					axis.tickGenerator = function(axis) {
						...
						if (opts.minTickSize != null) {
							if (typeof opts.tickSize == "number") {
								...
								minSize = opts.minTickSize[0] * timeUnitSize[opts.minTickSize[
									1]];
							}
						}
						...
						if (unit == "year") {
							...
							if (opts.minTickSize != null && opts.minTickSize[1] == "year") {
								...
								var magn = Math.pow(10, Math.floor(Math.log(axis.delta /
					...
					axis.tickFormatter = function(v, axis) {
						...
						if (opts.timeformat != null) {
							return formatDate(d, opts.timeformat, opts.monthNames, opts
								.dayNames);
						}
